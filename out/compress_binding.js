...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'compress_binding.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'compress_binding.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'compress_binding.temp.asm.js';
...
STATICTOP = STATIC_BASE + 425680;
/* global initializers */  __ATINIT__.push();


memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "compress_binding.js.mem" : null;




var STATIC_BUMP = 425680;
...
Module['wasmTableSize'] = 1456;

Module['wasmMaxTableSize'] = 1456;
...
var real__compress = asm["_compress"]; asm["_compress"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__compress.apply(null, arguments);
};
...
var _compress = Module["_compress"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_compress"].apply(null, arguments) };
