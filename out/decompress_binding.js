...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'decompress_binding.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'decompress_binding.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'decompress_binding.temp.asm.js';
...
STATICTOP = STATIC_BASE + 138992;
/* global initializers */  __ATINIT__.push();


memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "decompress_binding.js.mem" : null;




var STATIC_BUMP = 138992;
...
Module['wasmTableSize'] = 1664;

Module['wasmMaxTableSize'] = 1664;
